...
import { Text, View, TouchableOpacity, TextInput, Modal, TouchableWithoutFeedback, Keyboard, Image } from 'react-native';
            ...
            <View style={styles.container}>
                <Modal visible={isModalShow} animationType='slide'>
                    ...
                    <TouchableOpacity onPress={() => setIsModalShow(false)}>
                        <Ionicons name="close" size={16} style={styles.modalToggle} color="#24c48a"/>
                    </TouchableOpacity>
                </Modal>
                <View style={styles.complaintForm}>
                    <View>
                        <Text style={styles.contactText}>If you are having any problems with Timekeeper system, please fill in this form and we will solve your issue immediately.</Text>
                    </View>
                    <View style={styles.complaintView}>
                        ...
                        >
                            <MaterialCommunityIcons name="calendar-month-outline" size={16} color="#24c48a" />
                        </TouchableOpacity>
                    </View>
                    <TextInput
